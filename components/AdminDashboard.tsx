...
export function AdminDashboard() {
  ...
  return (
    <div>
      <div className="mb-10 flex gap-6 border-b border-line">
        <button
          onClick={() => setTab('products')}
          className={`pb-3 font-mono text-[11px] uppercase tracking-widest2 ${
            tab === 'products' ? 'border-b-2 border-ink text-ink' : 'text-stone'
          }`}
        >
          {t('productsTab')}
        </button>
        <button
          ...
          className={`pb-3 font-mono text-[11px] uppercase tracking-widest2 ${
            tab === 'orders' ? 'border-b-2 border-ink text-ink' : 'text-stone'
          }`}
        >
          {t('ordersTab')}
        </button>
      ...
      {tab === 'orders' ? (
        <div>
          {ordersLoading ? (
            ...
            <p className="font-body text-stone">No orders yet.</p>
          ) : (
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <select
                        ...
                        className="border border-line bg-transparent px-2 py-1.5 font-mono text-xs text-ink"
                      >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-body text-sm text-ink">
                          ...
                          {!p.available && (
                            <span className="ml-2 font-mono text-[10px] uppercase text-red-800">
                              hidden
                            </span>
                          )}
                        </p>
