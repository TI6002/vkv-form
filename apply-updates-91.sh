...
echo "Applying vkv.form updates — move hero title higher on the main banner..."
...
echo ""
echo "Done. git add -A && git commit -m \"Move hero title higher on the main banner\" && git push"