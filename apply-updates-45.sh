...
echo "Applying vkv.form updates (round 46 — cookie consent banner + cookie policy page)..."

mkdir -p "components"
cat > "components/CookieConsent.tsx" << '__VKV_PATCH_EOF__'
'use client';
...
__VKV_PATCH_EOF__
echo "  updated: components/CookieConsent.tsx"

mkdir -p "app/[locale]/cookie-policy"
cat > "app/[locale]/cookie-policy/page.tsx" << '__VKV_PATCH_EOF__'
...
__VKV_PATCH_EOF__
echo "  updated: app/[locale]/cookie-policy/page.tsx"
