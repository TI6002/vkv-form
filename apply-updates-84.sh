...
echo "Applying vkv.form updates — hero title top-center on mobile and desktop..."
...
echo "Done. git add -A && git commit -m \"Hero title top-center on mobile and desktop\" && git push"