...
echo "Applying vkv.form updates — fix mobile overflow on long names, manual per-language names for Collection Book..."
...
echo "Done. git add -A && git commit -m \"Fix mobile overflow + manual names for Collection Book\" && git push"