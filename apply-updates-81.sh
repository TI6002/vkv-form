...
echo "Applying vkv.form updates — restyle Philosophy section on homepage..."
...
echo ""
echo "Done. git add -A && git commit -m \"Restyle Philosophy section on homepage to match site's visual language\" && git push"