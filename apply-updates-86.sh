...
echo "Applying vkv.form updates — add editorial gallery section between Philosophy and catalogue..."
...
echo "Done. git add -A && git commit -m \"Add gallery section between Philosophy and catalogue\" && git push"